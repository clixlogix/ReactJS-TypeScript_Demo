...
class SimpleDialog extends React.Component<SimpleDialogPropsType> {
  handleClose = () => {
...
type SimpleDialogDemoStateType = {
  selectedValue: string
  open: boolean
}

class SimpleDialogDemo extends React.Component<{}, SimpleDialogDemoStateType> {
  state = {
    open: false,
...
type MaxWidth = unknown | false | "sm" | "xs" | "md" | "lg" | "xl" | undefined
type MaxWidthDialogStateType = {
  open: boolean
  fullWidth: boolean
  maxWidth: MaxWidth
}

class MaxWidthDialog extends React.Component<{}, MaxWidthDialogStateType> {
  state = {
    open: false,
    fullWidth: true,
  ...
  handleMaxWidthChange = (event: React.ChangeEvent<{ name?: string; value: unknown }>) => {
