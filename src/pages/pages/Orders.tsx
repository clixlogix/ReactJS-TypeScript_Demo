...
function createData(id: string, product: string, date: string, total: string, status: number, method: string) {
...
const EnhancedTableToolbar = (props: EnhancedTableToolbarPropsType) => { // Here was 'let'
