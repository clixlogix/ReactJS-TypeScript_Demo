...
import { NavLink as RouterNavLink, Link as RouterLink, LinkProps } from "react-router-dom";
...
function createData(customer: string, customerEmail: string, customerAvatar: string, status: number, amount: string, id: string, date: string) {
...
function stableSort(array: Array<RowType>, comparator: ( a: RowType, b: RowType ) => number) {
  const stabilizedThis = array.map((el: RowType, index: number) => ({el, index}));
